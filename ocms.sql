...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-03-31 12:59:15
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
INSERT INTO `column` (`id`, `pid`, `name`, `sort`, `content`, `elink`, `ilink`, `attr`, `page`, `list`, `doc`) VALUES
...
(42, 0, '测试oa', 0, '', 'http://www.baidu.com/', 39, 1, 'page.htm', 'list.htm', 'doc.htm'),
...
(1, '网站标题1', '网站关键字1', '网站描述网站描述网站描述', '版权信息版权信息版权信息1', '2134213', '234124321', '0');
...
INSERT INTO `doc` (`id`, `cate`, `title`, `content`, `AddTime`, `sort`, `hit`, `thumbnail`) VALUES
