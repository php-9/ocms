...
<div class="container-fluid">
	...
	<form class="form-horizontal" action="<?=site_url('c=page&m=insert_pass')?>" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
		      ...
		      <div class="col-sm-10">
				...
				<?php foreach($cats as $v):?>
				    <option value="<?=$v['id']?>" <?php if( !empty($this->session->userdata('cate_cache')) && $this->session->userdata('cate_cache')==$v['id']) echo "selected";?> ><?=str_repeat('&nbsp;&nbsp;&nbsp;&nbsp;',$v['level']);?><?=$v['name']?></option>
				<?php endforeach;?>
				</select>
		      </div>
