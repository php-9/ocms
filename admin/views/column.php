               ...
               <tr class="<?=$v['level']?>" style="<?php if($v['level']!=0){echo 'display:none';}?>">                  
                  ...
                  <td>
                      <p class="form-control-static">
                        ...
                        <span class="glyphicon glyphicon-plus-sign" aria-hidden="true" style="color:#ccc"></span>
                  ...
                  <td>
                    ...
                    <a href="<?php echo '../../index.php?c=column&m=col&cat_id='.$v['id']?>" target="_blank" title="预览栏目" class="btn btn-default btn-sm">预览</a>
                  </td>
               </tr>
